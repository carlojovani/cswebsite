...
HEATMAP_TIME_BUCKET_ORDER = ["0-15", "0-30", "0-45", "0-60", "0-75", "0-90", "0+"]
HEATMAP_DEFAULT_SLICE = "all"
DEATH_AWARENESS_LOOKBACK_SEC = 5
MULTIKILL_WINDOW_SEC = 10
MULTIKILL_EARLY_THRESHOLD_SEC = 30
PROXIMITY_RADIUS = 500
PROXIMITY_WINDOW_SEC = 3
PROXIMITY_SAMPLE_STEP_TICKS = 8
HOLD_RADIUS = 500
HOLD_WINDOW_SEC = 6
HOLD_OUTSIDE_SEC = 3
HEATMAP_BLUR_SIGMA_PRESENCE = 0.5
HEATMAP_GAMMA_PRESENCE = 0.9
HEATMAP_ALPHA_PRESENCE = 0.9
HEATMAP_CLIP_PCT_PRESENCE = 98.5
